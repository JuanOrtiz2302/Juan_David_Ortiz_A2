...
In this R Markdown document I will use a dataset containing 22 variables that contains 253680 objects. With this dataset I will show how to apply data analysis, Knn, linear and multilinear regression.
...
folder <- dirname(ELECTIVA::getSourceEditorContext()$path)
